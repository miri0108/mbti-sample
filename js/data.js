export const questions = [
  {
    ...
    choices: [
      { text: '파티 스텝은 못하지...<br>(그래도 파티는 재밌겠다 히히)', value: 'i' },
      { text: '재밌겠다!<br>○○한테 같이 지원하자고 해야지~', value: 'e' }
    ]
  },
  {
    number: '02',
    question: '해외 수학여행이 잡혔다!<br>전날 잠들기 전 나는?',
    choices: [
  ...
  {
    number: '03',
    question: '아르바이트 중, 친했던 동료가<br>그만둔다고?',
    choices: [
      { text: '일하면서 많이 힘들었나?<br>내가 좀 더 챙겨줄걸.', value: 'f' },
      { text: '아 취업하나?<br>그만두고 뭐하냐고 물어봐야지.', value: 't' }
    ]
  },
  {
    number: '04',
    question: '큰 프로젝트를 맡게 되어 떨리는 마음에 처음 시작한 건?',
    choices: [
      { text: '큰 프로젝트인 만큼 계획이 중요해!<br>목적과 목표 먼저 정리해봐야지!', value: 'j' },
      { text: '당장 회의 잡고<br>팀원이랑 이야기하면 되겠지?', value: 'p' }
    ]
  },
  {
    number: '05',
    question: '처음 가는 모임 장소!<br>나의 첫 인사말은?',
    choices: [
      { text: '안녕하세요ㅎㅎ 잘 부탁드려요~<br>(부끄러워 >///<)', value: '' },
      { text: '안녕하세요! 저는 00에 살고 있고요,<br>MBTI는 ~~ (빨리 친해져야지 >0<) ', value: '' }
    ]
  },
  {
    number: '06',
    ...
    choices: [
      { text: '날 좋은데 공부라니.<br>그런데 어쩌겠어? 공부해야지!', value: '' },
      { text: '이럴 때 공부할 순 없어!!<br>나가 놀꺼야!', value: '' }
    ]
  },
  {
    number: '07',
    question: '선생님한테 혼났다.<br>나는?',
    choices: [
      { text: '더 열심히 해서 잘할 수 있다는<br>사람이란 걸 보여주자!', value: '' },
      { text: '내가 재능이 없나?<br>하기 싫다..', value: '' }
    ]
  },
  {
    number: '08',
    question: '문제 푸는 데 너무 어려워ㅠㅠ<br>어떻게 해결하지?',
    choices: [
      { text: '시간을 더 끌 순 없지.<br>선생님한테 당장 물어봐야지!', value: '' },
      { text: '어떡하지.. 밤새더라도<br>방법을 더 찾아봐야겠다. ', value: '' }
    ]
  },
  {
    number: '09',
  ...
  {
    number: '10',
    question: '원하던 회사에 취업이 되었다.<br>나의 마음은?',
    choices: [
      { text: '드디어 세상이 날 알아주는구나!<br>가서 더 열심히 해야지!', value: '' },
      { text: '취업하면 월급 많이 받겠지?<br>월급 받으면 ○○ 사야지~ (상상의 나래~)', value: '' }
    ]
  },
]
export const results = [
  ...
  },
  {
    ...
    results: [
      '나는야 친구, 동료들 멘탈 지킴이!<br>언제나 토닥토닥 으샤으샤 응원하며 다니는 파워 인싸!',
      '여러 사람과 협업이 필요한 직무에 찰떡!',
      '진행력 갑! 추진력 갑!<br>빠른 속도로 동시에 여러 업무를 해결할 수 있어요.',
      '행사나 이벤트,<br>사람들 생일까지 우리가 다 챙길게요'
    ],
    jobs: ['마케터', '기획자']
  },
  {
    ...
    results: [
      ...
      '섬세함이 장점으로<br>일을 센스 있게 한다는 말을 자주 들어요.',
      '가끔은 거절을 잘 못해서 일이 몰릴 때가 있지만..!<br>전 괜찮아요~ (프로긍정러)',
      '일에 예민할 때도 있지만,<br>그래서 결과물은 완벽하죠!'
    ],
    jobs: ['디자이너', '예술가']
  },
  {
